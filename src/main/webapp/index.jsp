                        ...
                        <div class="row align-items-center">
                           <!-- Logo -->
                                <div class="col-xl-2 col-lg-2">
                                    <div class="logo">
                                        <a href="<c:url value='/index.jsp' />"><img src="<c:url value='/assets/img/logo/logo.png' />" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-xl-10 col-lg-10">
                                    <div class="menu-wrapper d-flex align-items-center justify-content-end">
                                        ...
                                        <div class="main-menu d-none d-lg-block">
                                            <nav>
                                                <ul id="navigation">
                                                    <li><a href="<c:url value='/courses.jsp' />">수업신청</a></li>
                                                    <li><a href="<c:url value='/about.jsp' />">회사소개</a></li>
                                                    <li><a href="#">서비스</a>
                                                        <ul class="submenu">
                                                            <li><a href="<c:url value='/blog.jsp' />">Blog</a></li>
                                                            <li><a href="<c:url value='/blog_details.jsp' />">Blog Details</a></li>
                                                            <li><a href="<c:url value='/elements.jsp' />">Element</a></li>
                                                        </ul>
                                                    </li>
                                                    <!-- <li><a href="<c:url value='/contact.jsp' />">Contact</a></li> -->
                                                    <!-- Display login/logout options based on user session -->
                                                    <c:choose>
                                                        <c:when test="${not empty sessionScope.user}">
                                                            <li class="button-header margin-left"><a href="<c:url value='/logout' />" class="btn">로그아웃</a></li>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <li class="button-header margin-left"><a href="<c:url value='/views/register.jsp' />" class="btn">회원가입</a></li>
                                                            <li class="button-header"><a href="<c:url value='/login.jsp' />" class="btn btn3">로그인</a></li>
                                                        </c:otherwise>
                                                    </c:choose>
                                                </ul>
                                            </nav>
    ...
    <main>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-7 col-md-12">
                                <div class="hero__caption">
                                   <h1 data-animation="fadeInLeft" data-delay="0.2s">특별한 파트너십<br> 만들기</h1>
                                    <p data-animation="fadeInLeft" data-delay="0.4s">더욱 특별한 이유를 찾아 드립니다!</p>
                                    <a href="<c:url value='/apply' />" class="btn hero-btn" data-animation="fadeInLeft" data-delay="0.7s">신청하기</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="services-area">
            <div class="container">
                <div class="row justify-content-sm-center">
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="single-services mb-30">
                            ...
                            <img src="<c:url value='/assets/img/icon/icon1.svg' />" alt="">
                            </div>
                    ...
                    <div class="single-services mb-30">
                        <div class="features-icon">
                            <img src="<c:url value='/assets/img/icon/icon2.svg' />" alt="">
                        </div>
                        <div class="features-caption">
                ...
                <div class="single-services mb-30">
                    <div class="features-icon">
                        <img src="<c:url value='/assets/img/icon/icon3.svg' />" alt="">
                    </div>
                    <div class="features-caption">
                ...
                <div class="courses-actives">
                    ...
                    <div class="properties pb-20">
                        <div class="properties__card">
                            ...
                            <a href="#"><img src="<c:url value='/assets/img/gallery/featured1.png' />" alt=""></a>
                            </div>
                    ...
                    <div class="properties pb-20">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                            <a href="#"><img src="<c:url value='/assets/img/gallery/featured2.png' />" alt=""></a>
                            </div>
                            <div class="properties__caption">
                                <p>User Experience</p>
                                <h3><a href="#">Fundamental of UX for Application design</a></h3>
                    ...
                    <div class="properties pb-20">
                        <div class="properties__card">
                            <div class="properties__img overlay1">
                                <a href="#"><img src="<c:url value='/assets/img/gallery/featured3.png' />" alt=""></a>
                            </div>
                            <div class="properties__caption">
                                <p>User Experience</p>
                                <h3><a href="#">Fundamental of UX for Application design</a></h3>
            ...
            <div class="support-wrapper align-items-center">
                <div class="left-content1">
                    ...
                    <div class="single-features">
                        <div class="features-icon">
                        <img src="<c:url value='/assets/img/icon/right-icon.svg' />" alt="">
                        </div>
                        <div class="features-caption">
                ...
                <div class="right-content1">
                    <!-- img -->
                    <div class="right-img">
                        <img src="<c:url value='/assets/img/gallery/about.png' />" alt="">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-topic text-center mb-30">
                            <div class="topic-img">
                            <img src="<c:url value='/assets/img/gallery/topic1.png' />" alt="">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-topic text-center mb-30">
                            <div class="topic-img">
                                <img src="<c:url value='/assets/img/gallery/topic2.png' />" alt="">
                                <div class="topic-content-box">
                                    <div class="topic-content">
                                        <h3><a href="#">Programing</a></h3>
                                    </div>
                    ...
                    <div class="col-lg-3 col-md=4 col-sm-6">
                        <div class="single-topic text-center mb-30">
                            <div class="topic-img">
                                <img src="<c:url value='/assets/img/gallery/topic3.png' />" alt="">
                                <div class="topic-content-box">
                                    <div class="topic-content">
                                        <h3><a href="#">Programing</a></h3>
                                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-topic text-center mb-30">
                            <div class="topic-img">
                            <img src="<c:url value='/assets/img/gallery/topic4.png' />" alt="">
                                <div class="topic-content-box">
                                    <div class="topic-content">
                                        <h3><a href="#">Programing</a></h3>
                                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-topic text-center mb-30">
                            <div class="topic-img">
                            <img src="<c:url value='/assets/img/gallery/topic5.png' />" alt="">
                                <div class="topic-content-box">
                                    <div class="topic-content">
                                        <h3><a href="#">Programing</a></h3>
                                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-topic text-center mb-30">
                            <div class="topic-img">
                            <img src="<c:url value='/assets/img/gallery/topic6.png' />" alt="">
                                <div class="topic-content-box">
                                    <div class="topic-content">
                                        <h3><a href="#">Programing</a></h3>
                                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-topic text-center mb-30">
                            <div class="topic-img">
                            <img src="<c:url value='/assets/img/gallery/topic7.png' />" alt="">
                                <div class="topic-content-box">
                                    <div class="topic-content">
                                        <h3><a href="#">Programing</a></h3>
                                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-topic text-center mb-30">
                            <div class="topic-img">
                            <img src="<c:url value='/assets/img/gallery/topic8.png' />" alt="">
                                <div class="topic-content-box">
                                    <div class="topic-content">
                                        <h3><a href="#">Programing</a></h3>
                                    </div>
        ...
        <section class="about-area3 fix">
            <div class="support-wrapper align-items-center">
                <div class="right-content3">
                    <!-- img -->
                    <div class="right-img">
                        <img src="<c:url value='/assets/img/gallery/about3.png' />" alt="">
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="team-active">
                    <div class="single-cat text-center">
                        <div class="cat-icon">
                            <img src="<c:url value='/assets/img/gallery/team1.png' />" alt="">
                            </div>
                        <div class="cat-cap">
                    ...
                    <div class="single-cat text-center">
                        <div class="cat-icon">
                        <img src="<c:url value='/assets/img/gallery/team2.png' />" alt="">
                            </div>
                        <div class="cat-cap">
                    ...
                    <div class="single-cat text-center">
                        <div class="cat-icon">
                            <img src="<c:url value='/assets/img/gallery/team3.png' />" alt="">
                        </div>
                        <div class="cat-cap">
                    ...
                    <div class="single-cat text-center">
                        <div class="cat-icon">
                        <img src="<c:url value='/assets/img/gallery/team4.png' />" alt="">
                        </div>
                        <div class="cat-cap">
                        ...
                        <div class="single-footer-caption mb-50">
                            <div class="single-footer-caption mb-30">
                                ...
                                <div class="footer-logo mb-25">
                                    <a href="index.jsp"><img src="<c:url value='/assets/img/logo/logo2_footer.png' />" alt=""></a>
                                </div>
