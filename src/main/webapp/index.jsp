                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-7 col-md-12">
                                <div class="hero__caption">
                                    <h1 data-animation="fadeInLeft" data-delay="0.2s">온라인 클래스메이트<br> 플랫폼</h1>
                                    <p data-animation="fadeInLeft" data-delay="0.4s">다 같이 모여 틀린 문제를 공유하고 회의를 시작해보자!</p>
                                    <a href="#" class="btn hero-btn" data-animation="fadeInLeft" data-delay="0.7s">접속하기</a>
                                </div>
                            </div>
                        </div>
                    </div>          
